...
const GoalToWorkoutAdapter = ({/*index, updateAchieved,*/ workoutGoalUrl}) => {
    ...
    return <WorkoutListItem workoutUrl={workoutGoal.workout}/* index={index} updateComplete={this.props.updateAchieved}*//>   
  }
